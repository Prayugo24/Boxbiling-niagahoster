...
class __TwigTemplate_d66d39ced1302073565253c0188cead9ba547670fafd804fe8ba706760fb3aca extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {% endfor %}
{% endfor %}", "partial_message.phtml", "/usr/local/var/www/kerja/projeck_self/BoxBilling/bb-themes/boxbilling/html/partial_message.phtml");
    }
}
